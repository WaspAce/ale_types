...
*/
declare type ResourceRequestHandlerOnGetCookieAccessFilter = (
  browser: Browser,
  frame: Frame,
  request: Request
) => CookieAccessFilter;
...
*/
declare type ResourceRequestHandlerOnBeforeResourceLoad = (
  browser: Browser,
  frame: Frame,
  request: Request
) => boolean;
...
*/
declare type ResourceRequestHandlerOnGetResourceHandler = (
  browser: Browser,
  frame: Frame,
  request: Request
) => ResourceHandler;
...
*/
declare type ResourceRequestHandlerOnResourceRedirect = (
  browser: Browser,
  frame: Frame,
  request: Request,
  response: Response,
...
*/
declare type ResourceRequestHandlerOnResourceResponse = (
  browser: Browser,
  frame: Frame,
  request: Request,
  response: Response
...
*/
declare type ResourceRequestHandlerOnGetResourceResponseFilter = (
  browser: Browser,
  frame: Frame,
  request: Request,
  response: Response
...
* frame is invalid.
*/
declare type ResourceRequestHandlerOnResourceLoadComplete = (
  browser: Browser,
  frame: Frame,
  request: Request,
  response: Response,
...
declare class ResourceRequestHandler {
   ...
   * @event
   */
  on_get_cookie_access_filter: ResourceRequestHandlerOnGetCookieAccessFilter;
   ...
   * @event
   */
  on_get_resource_handler: ResourceRequestHandlerOnGetResourceHandler;

  /**
   * Called when a resource load is redirected.
   * @event
   */
  on_resource_redirect: ResourceRequestHandlerOnResourceRedirect;

  /**
   * Called when a resource response is received.
   * @event
   */
  on_resource_response: ResourceRequestHandlerOnResourceResponse;

  /**
   * Called to optionally filter resource response content.
   * @event
   */
  on_get_resource_response_filter: ResourceRequestHandlerOnGetResourceResponseFilter;

  /**
   * Called when a resource load has completed.
   * @event
   */
  on_resource_load_complete: ResourceRequestHandlerOnResourceLoadComplete;
}
