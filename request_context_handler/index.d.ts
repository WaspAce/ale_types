...
*/
declare type RequestContextHandlerOnBeforePluginLoad = (
  mime_type: string,
  plugin_url: string,
...
*/
declare type RequestContextHandlerOnGetResourceRequestHandler = (
  browser: Browser,
  frame: Frame,
  request: Request,
...
declare class RequestContextHandler {
   ...
   * @event
   */
  on_request_context_initialized: RequestContextHandlerOnRequestContextInitialized;

  /**
   * Called before a plugin instance is loaded.
   * @event
   */
  on_before_plugin_load: RequestContextHandlerOnBeforePluginLoad;

  /**
   * Called before a resource request is initiated.
   */
  on_get_resource_request_handler: RequestContextHandlerOnGetResourceRequestHandler;
}
