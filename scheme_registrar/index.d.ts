...
declare class SchemeRegistrar {
   ...
   * headers to further restrict access.
	 ...
	 * |is_standard| is true.
	 *
	 * This function should only be called once per unique |scheme_name| value.
   * If |scheme_name| is already registered or if an error occurs this function will return false.
   */
  add_custom_scheme(
    scheme_name: string,
    is_standard: boolean,
