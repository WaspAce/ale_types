declare interface LifeSpanHandlerOnBeforePopupResult {
    allow: boolean;
...
*/
declare type LifeSpanHandlerOnBeforePopup = (
  browser: Browser,
  frame: Frame,
  target_url: string,
...
) => LifeSpanHandlerOnBeforePopupResult;

/**
* This callback will be the first notification that references |browser|.
*/
declare type LifeSpanHandlerOnAfterCreated = (
  browser: Browser
) => void;

declare type LifeSpanHandlerOnClose = (
  browser: Browser
) => boolean;
...
*/
declare type LifeSpanHandlerOnBeforeClose = (
  browser: Browser
) => void;
...
declare class LifeSpanHandler {
   ...
   * @event
   */
  on_before_popup: LifeSpanHandlerOnBeforePopup;

  /**
   * Called after a new browser is created.
   * @event
   */
  on_after_created: LifeSpanHandlerOnAfterCreated;
   ...
   * @event
   */
  on_close: LifeSpanHandlerOnClose;

  /**
   * Called just before a browser is destroyed.
   * @event
   */
  on_before_close: LifeSpanHandlerOnBeforeClose;
}
